...
$sql_count_exams = "SELECT COUNT(*) as count FROM exams";
...
$sql_count_clients = "SELECT COUNT(DISTINCT client_name) as count FROM exams";
    ...
    <div class="main">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        <h4 class="card-title"><i class="fa fa-file"></i> Cantidad de exámenes</h4>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        <h4 class="card-title"><i class="fa fa-users"></i> Clientes registrados</h4>
            ...
            <div class="col-md-8" style="height: 370px;">
                <div class="card">
                    <div class="card-body" style="max-height: 370px;">
                        ...
                        <canvas id="paymentChart" style="height: 300px; display: flex; width: 690px;"></canvas>
                    </div>
                </div>
            </div>
